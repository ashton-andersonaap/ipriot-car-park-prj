...
| ---------- |----------------------------------------------------|---------------------------------------------------|
| `CarPark`    | available bays<br/>unavailable bays<br/>total bays | bay filled<br/>bay emptied<br/>bays status        |
| `Sensor`     | licence plate<br/>time entered                     | car entered<br/>car exit<br/>                     |
| `Display`    | weather <br/>announcements                         | show weather<br/>show announcements<br/>show bays |
...
1. Add a screenshot of the output of the unit tests. If any failed, add a screenshot of the error message and a screenshot after you have fixed the errors:
   ...
   ![Unit tests](screenshots/car_park_unittest.png)
...
1. Add a screenshot of the output of the unit tests. If any failed, add a screenshot of the error message and a screenshot after you have fixed the errors:
   ...
   ![Unit tests](screenshots/display_unittest.png)
...
> In the carpark unit because that is where the Display or sensor can be accepted.  
> 
> 
...
![Added methods to the car park class](screenshots/config_github.png)
...
1. Add a screenshot of the output of the `main.py` file:
   ...
   ![Main.py output](screenshots/main_output.png)
